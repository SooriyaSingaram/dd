...
export class CustomTemplateComponent implements OnInit {
    ...
    pdfcustom:boolean=false;
    emailcustom:boolean=false;
    yaxis: string;
    xaxis: string;
    zaxis:string;
    y_axis: string;
    ...
    heading: string; summary: any; csv: boolean = false; pdf: boolean = false; mail: boolean = false; position: string; ctype: string;graphdesc:String;charthead:String;chartdesc:String;
    ...
    droparea1: boolean = true; droparea2: boolean = true;; droparea3: boolean = true;; droparea4: boolean = true;;
    ...
    updateTemplate() {
      ...
      this.template.emailData={
        'emailSubject':this.emailSubject,
        'emailBody':this.emailBody
      }
      console.log(this.template.emailData)
  
      //this.template.customeTemplateName = localStorage.getItem("templateName")
      console.log(this.template)
      this.apicall.updateTemplate(this.template).subscribe(res => {
        this.result = res.message
        console.log(this.result);
        this.alert.success("Template Customized Successfully")
    ...
    updateWidget() {
      ...
      this.widget.chartHeading=this.charthead
      this.widget.graphDefinition=this.chartdesc
      this.widget.customeHeading = this.heading
      this.widget.customDefinition = this.graphdesc
    ...
    editChart(data: string) {
      ...
      this.template.widget.forEach((item, index) => {
        ...
        if (item.row == data) {
          ...
          this.charthead=item.chartHeading
          this.chartdesc=item.graphDefinition
          this.position = item.row
          this.heading = item.customeHeading
          this.graphdesc = item.customDefinition
          ...
          if(item.chartType == "Stacked Line Chart"){
            this.ZAxis = true;
            this.HideShow =true;
            this.z_axis = item.chartField[2];
