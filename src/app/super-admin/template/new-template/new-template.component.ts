...
export class NewTemplateComponent implements OnInit {
  ...
  public addDropItem(arraytype, event) {
    ...
    if (arraytype == "itemsDropped5" && this.itemsDropped5.length == 0 && !this.showForm) {
      this.showForm = true;
      this.close_5 = true;
      if (this.itemdrop5) {
        this.itemsDropped5.push(event);
        this.widget.row = "item5"
        this.itemdrop5 = false;
      }
    }
