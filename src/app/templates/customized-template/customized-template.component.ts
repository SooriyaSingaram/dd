...
@Component({
  ...
  styleUrls: ['./customized-template.component.scss']
})
export class CustomizedTemplateComponent implements OnInit{ 
  
  dynamic_filter: FormControl;
...
constructor(private service: ChartService, private route: ActivatedRoute, private http: Http, private model: ModelDataService, private apicall: ApicallService, private router: Router,private datepipe: DatePipe) {
  this.dynamic_filter = new FormControl();
}
...
ngOnInit() {
  ...
  this.apicall.getUserById(this.id).subscribe(res => {
    ...
    this.apicall.getOrganizationById(res.OrganizationId).subscribe(response => {
      ...
      userTemplates.unshift({ id: '1', itemName: 'Home page' })
  ...
  this.sub = this.route.params.subscribe(params => {
    this.id = params['id'];
    let pdfContent = params['id2'];
    let pdfName =params['name'];
    if (this.id != "0") {
...
loadTableData(data: string) {
    ...
    this.router.navigate(['/customized-template/', data]);
  ...
  this.service.getDynamicData(this.template.table, widget1.chartField, widget1.summaryByFields, widget1.userFilter, widget1.percentFilter, this.template.contentFilter, this.sortOrder, this.dateRangeFilter).subscribe(res => {
    ...
    if (widget1.chartType == "Line area Chart") {
      if (this.lineareaCount == 1) {
        ...
        this.lineareaheading1 = widget1.customeHeading
        this.linedesc1 = widget1.customDefinition
        ...
        let linearealabel1 = this.chartResult.map(res => res.label);
        let lineaddress1 =this.chartResult.map(res=>res.address)
        // console.log(lineaddress1)
        if (this.linearealabel1.length > 0) {
          this.linearealabel1.length = 0;
          this.lineAreaChartLabels1.length = 0;
        }
        for (let i = 0; i < linearealabel1.length; i++) {
          this.linearealabel1.push(linearealabel1[i]);
        }
        ...
        this.lineareaheading2 = widget1.customeHeading
        this.linedesc2 = widget1.customDefinition          
        ...
        for (let i = 0; i < linearealabel1.length; i++) {
          this.linearealabel2.push(linearealabel1[i]);
        }
        ...
        this.lineareaheading3 = widget1.customeHeading
        this.linedesc3 = widget1.customDefinition          
        ...
        for (let i = 0; i < linearealabel1.length; i++) {
          this.linearealabel3.push(linearealabel1[i]);
        }
        ...
        this.lineareaheading4 = widget1.customeHeading
        this.linedesc4 = widget1.customDefinition          
        ...
        for (let i = 0; i < linearealabel1.length; i++) {
          this.linearealabel4.push(linearealabel1[i]);
        }
    ...
    if (widget1.chartType == "Pie Chart") {
      if (this.pieCount == 1) {
        ...
        this.pieheading1 = widget1.customeHeading
        this.piedesc1= widget1.customDefinition
        ...
        this.pieheading2 = widget1.customeHeading
        this.piedesc2 = widget1.customDefinition          
        ...
        this.pieheading3 = widget1.customeHeading
        this.piedesc3 = widget1.customDefinition                    
        ...
        this.pieheading4 = widget1.customeHeading
        this.piedesc4 = widget1.customDefinition                    
    ...
    if (widget1.chartType == "Bar Chart") {        
      if (this.barcount == 1) {
        ...
        this.barheading1 = widget1.customeHeading
        this.bardesc1 = widget1.customDefinition          
        ...
        for (let i = 0; i < barlabel1.length; i++) {
          this.barlabel1.push(barlabel1[i]);
        }
        ...
        this.barheading2 = widget1.customeHeading
        this.bardesc2 = widget1.customDefinition                    
        ...
        for (let i = 0; i < barlabel1.length; i++) {
          this.barlabel2.push(barlabel1[i]);
        }
        ...
        this.barheading3 = widget1.customeHeading
        this.bardesc3 = widget1.customDefinition                    
        ...
        for (let i = 0; i < barlabel1.length; i++) {
          this.barlabel3.push(barlabel1[i]);
        }
        ...
        this.barheading4 = widget1.customeHeading
        this.bardesc4 = widget1.customDefinition                    
        ...
        for (let i = 0; i < barlabel1.length; i++) {
          this.barlabel4.push(barlabel1[i]);
        }
    ...
    if (widget1.chartType == "Line Chart") {
      if (this.lineCount == 1) {
        ...
        this.lineheading1 = widget1.customeHeading
        this.linechartdesc1 = widget1.customDefinition                    
        ...
        for (let i = 0; i < linelabel1.length; i++) {
          this.linelabel1.push(linelabel1[i]);
        }
        ...
        this.lineheading2 = widget1.customeHeading
        this.linechartdesc2 = widget1.customDefinition                              
        ...
        for (let i = 0; i < linelabel1.length; i++) {
          this.linelabel2.push(linelabel1[i]);
        }
        ...
        this.lineheading3 = widget1.customeHeading
        this.linechartdesc3 = widget1.customDefinition                             
        ...
        for (let i = 0; i < linelabel1.length; i++) {
          this.linelabel3.push(linelabel1[i]);
        }
        ...
        this.lineheading4 = widget1.customeHeading
        this.linechartdesc4 = widget1.customDefinition                              
        ...
        for (let i = 0; i < linelabel1.length; i++) {
          this.linelabel4.push(linelabel1[i]);
        }
    ...
    if (widget1.chartType == "Stacked Chart") {
      if (this.stackedCount == 1) {
        ...
        this.stackbarheading1 = widget1.customeHeading
        this.stackdesc1 = widget1.customDefinition                    
        ...
        let stacklabel = this.stackLabelResult(this.chartResult)
        ...
        let stackdata = this.stackedFormat(this.chartResult)
        ...
        this.stackbarheading2 = widget1.customeHeading
        this.stackdesc2 = widget1.customDefinition                              
        ...
        this.stackbarheading3 = widget1.customeHeading
        this.stackdesc3 = widget1.customDefinition                              
        ...
        this.stackbarheading4 = widget1.customeHeading
        this.stackdesc4 = widget1.customDefinition                              
    ...
    if (widget1.chartType == "Stacked Line Chart") {
      ...
      if (this.stackLineCount == 1) {
        ...
        this.stacklineheading1 = widget1.customeHeading
        this.stacklinedesc1 = widget1.customDefinition                              
        ...
        let stacklinedata = this.stackLineFormat(this.chartResult)
        ...
        this.stacklineheading2 = widget1.customeHeading
        this.stacklinedesc2 = widget1.customDefinition                              
        ...
        this.stacklineheading3 = widget1.customeHeading
        this.stacklinedesc3 = widget1.customDefinition                              
        ...
        this.stacklineheading4 = widget1.customeHeading
        this.stacklinedesc4 = widget1.customDefinition                              
...
stackedFormat(sampleResult) {
  ...
  sampleResult.map((item, index) => {
    ...
    if (this.stackdata.length < 1) {
      this.stackdata.push({ data: [item.value], label: item.name })
    } else {
...
stackLineFormat(sampleResult) {
  ...
  sampleResult.map((item, index) => {
    ...
    if (this.stacklinedata.length < 1) {
      this.stacklinedata.push({ data: [item.value], label: item.name })
    } else {
...
url:any='http://localhost:4200/#/customized-template/5b8790223adbc11628d02355'
  ...
  html2canvas(document.getElementById(id),{
    ...
    onrendered: function (canvas) {
      ...
      var imgData = canvas.toDataURL(
          'image/jpeg',1);
      var doc = new jsPDF("p", "px", [divWidth,divHeight]);
      doc.deletePage(1);
      doc.addPage(divWidth, divHeight);
...
//      this.downloadFile('https://pdfmyurl.com/api?license=gjXBgIr9Dsva&url=http://34.238.131.221:4200&page_size=A4&orientation=landscape', 'name.pdf');
//   }
  
//     downloadFile(data, fileName){
//           debugger;
//           this.toDataURL(data, function(dataUrl) {
...
emailPdf0(email) {
  ...
  pdf.addHTML(elementToPrint, () => {
    ...
    this.service.emailDashboard({ "data": dataString, name: this.EmailHeading, email: email }).subscribe(res => {
    })
    // this.closepopup()
  });
}
...
emailPdf(email) {
  ...
  var divWidth = document.getElementById(this.emailDiv).offsetWidth;
  var divHeight = document.getElementById(this.emailDiv).offsetHeight;
  let self = this;
  html2canvas(document.getElementById(this.emailDiv), {
    removeContainer: true,
    letterRendering: true,
    scale: 5,
    backgroundColor: "#f4f7fa",
    onrendered: function (canvas) {
      ...
      self.service.emailDashboard({ "data": uriString, emailSubject: self.emailFields.emailSubject, emailBody: self.emailFields.emailBody, email: email }).subscribe(res => {
      })
      //doc.save(name + '.pdf');
    }
